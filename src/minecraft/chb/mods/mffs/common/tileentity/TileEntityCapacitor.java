...
INetworkHandlerEventListener,IForceEnergyStorageBlock,IPeripheral{
			...
			if (getStackInSlot(2).getItem() instanceof IForceEnergyItems) {
					...
					if(this.getStorageAvailablePower() > 0)
					{
					  if(this.getStorageAvailablePower() > maxtransfer)
					  {
						    if(freeeamount > maxtransfer)
						    {
				                ...
				                this.setForcePower(this.getStorageAvailablePower() - freeeamount);
						    }
					  }else{
						    if(freeeamount > this.getStorageAvailablePower())
						    {
						    	ForceEnergyItem.setAvailablePower(getStackInSlot(2), ForceEnergyItem.getAvailablePower(getStackInSlot(2))+this.getStorageAvailablePower());
				                this.setForcePower(this.getStorageAvailablePower() - this.getStorageAvailablePower());
						    }else{
						    	ForceEnergyItem.setAvailablePower(getStackInSlot(2), ForceEnergyItem.getAvailablePower(getStackInSlot(2))+freeeamount);
				                this.setForcePower(this.getStorageAvailablePower() - freeeamount);
						    }
				...
				case 4:
					...
					if(ForceEnergyItem.getAvailablePower(getStackInSlot(2)) > 0)
					{
						...
						int maxtransfer = ForceEnergyItem.getPowerTransferrate();
						int freeeamount = this.getStorageMaxPower() - this.getStorageAvailablePower();
	...
	public String[] getMethodNames() {
		 return new String[] { "isActive","getTransmitRange","getPercentageStorageCapacity","getcountlinketdevice","getforceenergy","getStorageMaxPower","getfreeStorageAmount"};
	}
